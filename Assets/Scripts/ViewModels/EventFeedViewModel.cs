...
public class EventFeedViewModel : ViewModel
{
    ...
    [Header("UP Card Object References")]
    ...
    private void Start()
    {
        Initialize<EventFeedViewModel, EventFeedPresenter, EventFeedInteractor>();
    }
    ...
    private void InstanceEventObject(List<EventEntity> eventsEntities, int nextPage) {
        ...
        for (int i = 0; i < eventsEntities.Count; i++)
        {
            ...
            eventObjectComponent.HasAssited(false);
